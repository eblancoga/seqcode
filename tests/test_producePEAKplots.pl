...
my $PEAKS = "tests/inputs/H3K4me3_mESC_sample.bed";
...
print_mess("Stage 3.  Running the test for H3K4me3 --chr10:5,774,999-6,225,000 (mm9)-- in mESC (uniform plot)\n");
...
print_mess("Stage 4.  Running the test for H3K4me3 --chr10:5,774,999-6,225,000 (mm9)-- in mESC (one peak, default plot)\n");
...
print_mess("Stage 5.  Running the test for H3K4me3 --chr10:5,774,999-6,225,000 (mm9)-- in mESC (another color scheme)\n");
...
print_mess("Stage 6.  Running the test for H3 --chr10:5,774,999-6,225,000 (mm9)-- in mESC (default plot)\n");
