...
print_mess("Stage 1.  Running test for H3K4me3 --chr10:5,774,999-6,225,000 (mm9)-- in mESC (default profile)\n");
...
print_mess("Stage 2.  Running test for H3K4me3 --chr10:5,774,999-6,225,000 (mm9)-- in mESC (w=1000 profile)\n");
...
print_mess("Stage 3.  Running test for H3 --chr10:5,774,999-6,225,000 (mm9)-- in mESC (default profile)\n");
...
print_mess("Stage 4.  Finishing test ($TOOL)\n");
...
sub check_files
{
    ...
    # 3
    $file_output = "$OUTPUT_FOLDER/test_3_profile/test_3.bedgraph.gz";
